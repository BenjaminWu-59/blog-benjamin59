    ...
    <div className="as-scroll-container py-5 flex overflow-hidden">
      <section className="flex as-scroll-animate" >
        {items.map((item, index) => (
          <div key={index} className="z-10 w-[400px] h-[250px] m-5 px-4 flex-grow bg-background rounded-3xl cursor-pointer border border-border flex flex-col shadow-normal">
